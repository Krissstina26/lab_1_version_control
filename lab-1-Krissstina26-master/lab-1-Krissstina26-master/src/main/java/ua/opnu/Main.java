...
public class Main {
     ...
     * neither of them is smiling. Return true if we are in
     * trouble.
     * Example:
    ...
    /**
     * Given a string of even length, return a
     * string mad e of the middle two chars, so
     * the string "string" yields "ri".
